...
\textbf{MlflowClient (Automation):}
\begin{lstlisting}[language=python]
from mlflow.tracking import MlflowClient
client = MlflowClient()
# Find best run
runs = client.search_runs(exp_id, order_by=["metrics.acc DESC"])
...
def my_taskflow_dag():
    ...
    transform(extract()) # Dependencies set via call
